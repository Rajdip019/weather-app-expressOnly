...
app.post("/popular-cities", function(req, res){
    ...
    https.get(url, function (response) {
        ...
        res.write("<style>.min-max{width: 25rem}.flex{display: flex;}h3{padding: 0.5rem; }footer{text-align: center;background-color: black; color: white; height: 5vh;line-height: 5vh; }</style>");
        res.write("<style>.popular_heading{padding-top: 4rem}.popular_city_flex{display: flex}.new_loc_btn form button{padding: 0.4rem;font-size: 1.25rem;background-color: rgba(0, 234, 255, 0.589);border-radius: 10px;border-color: transparent;font-weight: 900;cursor: pointer;}</style>")
        res.write("<header> Weather App</header>");
        res.write("<h1 class='popular_heading'>Weather of Popular Cities.</h1>")
