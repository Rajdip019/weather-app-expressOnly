...
app.post("/", function (req, res) {
    ...
    https.get(url, function (response) {
        ...
        response.on("data", function (data) {
            ...
            res.write("<div class='main'><div class='form'><h1>The temperature in "+palce+ " is: " + temp + " Degree celcius.</h1><h3>The Weather Currently is: " + weatherData.weather[0].description+ ". </h3><h3>Min Temp: "+temp_min+ " celcius</h3><h3>Max Temp: "+temp_max+ " celcius</h3><h3>Humidity: "+humidity+ "%</h3><img src=" + imageURL + "></div></div>");
